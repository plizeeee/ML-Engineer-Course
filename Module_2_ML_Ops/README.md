...
This project demonstrates how I performed ML Ops on a test dataset using Azure for the Udacity Azure ML Course.
...
## Key Steps
This section includes a short description of the key steps in this project.
